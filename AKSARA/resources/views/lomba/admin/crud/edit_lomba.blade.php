...
<form id="formAdminEditLomba" action="{{ route('admin.lomba.crud.update_ajax', $lomba->lomba_id) }}" method="POST"
    ...
    <div class="modal-body" style="max-height: 65vh; overflow-y: auto;">
        ...
        <div class="row mb-3">
            <label for="crud_edit_nama_lomba" class="col-sm-3 col-form-label text-md">Nama Lomba <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" name="nama_lomba" id="crud_edit_nama_lomba" class="form-control"
        ...
        <div class="row mb-3">
            <label for="crud_edit_pembukaan_pendaftaran" class="col-sm-3 col-form-label text-md">Pembukaan Pendaftaran
                <span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="date" name="pembukaan_pendaftaran" id="crud_edit_pembukaan_pendaftaran"
                    class="form-control"
                    value="{{ old('pembukaan_pendaftaran', $lomba->pembukaan_pendaftaran ? $lomba->pembukaan_pendaftaran->format('Y-m-d') : '') }}"
                    required>
                <span class="invalid-feedback error-pembukaan_pendaftaran"></span>
            </div>
        </div>
        <div class="row mb-3">
            <label for="crud_edit_batas_pendaftaran" class="col-sm-3 col-form-label text-md">Batas Pendaftaran <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="date" name="batas_pendaftaran" id="crud_edit_batas_pendaftaran" class="form-control"
                    value="{{ old('batas_pendaftaran', $lomba->batas_pendaftaran ? $lomba->batas_pendaftaran->format('Y-m-d') : '') }}"
                    required>
                <span class="invalid-feedback error-batas_pendaftaran"></span>
            </div>
        </div>
        <div class="row mb-3">
            <label for="crud_edit_kategori" class="col-sm-3 col-form-label text-md">Kategori <span
                    class="text-danger">*</span></label>
            <div class="col-sm-3">
            ...
            <label for="crud_edit_tingkat" class="col-sm-3 col-form-label text-md-end  ">Tingkat <span
                    class="text-danger">*</span></label>
            <div class="col-sm-3">
        ...
        <div class="row mb-3">
            <label for="crud_edit_penyelenggara" class="col-sm-3 col-form-label text-md">Penyelenggara <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" name="penyelenggara" id="crud_edit_penyelenggara" class="form-control"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="number" name="biaya" id="crud_edit_biaya" class="form-control"
                    value="{{ old('biaya', $lomba->biaya) }}" min="0">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="url" name="link_pendaftaran" id="crud_edit_link_pendaftaran" class="form-control"
                    value="{{ old('link_pendaftaran', $lomba->link_pendaftaran) }}">
                <span class="invalid-feedback error-link_pendaftaran"></span>
            </div>
        </div>
        <div class="row mb-3">
            <label for="crud_edit_link_penyelenggara" class="col-sm-3 col-form-label text-md">Link
                Penyelenggara</label>
            <div class="col-sm-9">
                <input type="url" name="link_penyelenggara" id="crud_edit_link_penyelenggara"
                    class="form-control" value="{{ old('link_penyelenggara', $lomba->link_penyelenggara) }}">
        ...
        <div class="row mb-3">
            <label for="crud_edit_status_verifikasi" class="col-sm-3 col-form-label text-md">Status Verifikasi <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <select name="status_verifikasi" id="crud_edit_status_verifikasi" class="form-select" required>
                    ...
                    <option value="disetujui"
                        {{ old('status_verifikasi', $lomba->status_verifikasi) == 'disetujui' ? 'selected' : '' }}>
                        Disetujui</option>
                    <option value="ditolak"
                        {{ old('status_verifikasi', $lomba->status_verifikasi) == 'ditolak' ? 'selected' : '' }}>
                        Ditolak</option>
                </select>
        ...
        <div class="row mb-3" id="crud_edit_catatan_verifikasi_wrapper"
            ...
            <label for="crud_edit_catatan_verifikasi" class="col-sm-3 col-form-label text-md">Catatan
                Verifikasi</label>
            <div class="col-sm-9">
