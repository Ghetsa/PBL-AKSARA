...
<form id="formAdminCrudLomba"
    action="{{ isset($lomba) ? route('admin.lomba.crud.update_ajax', $lomba->lomba_id) : route('admin.lomba.crud.store_ajax') }}"
    ...
    <div class="modal-header bg-{{ isset($lomba) ? 'warning text-dark' : 'primary text-white' }}">
        <h5 class="modal-title">{{ isset($lomba) ? 'Edit Informasi Lomba (Admin)' : 'Tambah Info Lomba Baru (Admin)' }}
        </h5>
        <button type="button" class="btn-close {{ isset($lomba) ? '' : 'btn-close-white' }}" data-bs-dismiss="modal"
    ...
    <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="nama_lomba" id="crud_nama_lomba" class="form-control"
                    value="{{ old('nama_lomba', $lomba->nama_lomba ?? '') }}" required>
                <span class="invalid-feedback error-nama_lomba"></span>
            </div>

            <div class="col-md-6 mb-3">
                <label for="crud_pembukaan_pendaftaran" class="form-label">Pembukaan Pendaftaran <span
                        class="text-danger">*</span></label>
                <input type="date" name="pembukaan_pendaftaran" id="crud_pembukaan_pendaftaran" class="form-control"
            ...
            <div class="col-md-6 mb-3">
                <label for="crud_batas_pendaftaran" class="form-label">Batas Pendaftaran <span
                        class="text-danger">*</span></label>
                <input type="date" name="batas_pendaftaran" id="crud_batas_pendaftaran" class="form-control"
            ...
            <div class="col-md-12 mb-3">
                <label for="crud_penyelenggara" class="form-label">Penyelenggara <span
                        class="text-danger">*</span></label>
                <input type="text" name="penyelenggara" id="crud_penyelenggara" class="form-control"
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="number" name="biaya" id="crud_biaya" class="form-control"
                    value="{{ old('biaya', $lomba->biaya ?? '') }}" min="0" placeholder="Contoh: 50000">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="url" name="link_pendaftaran" id="crud_link_pendaftaran" class="form-control"
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="url" name="link_penyelenggara" id="crud_link_penyelenggara" class="form-control"
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="file" name="poster" id="crud_poster" class="form-control"
            ...
            <div class="col-md-12 mb-3">
                <label for="crud_status_verifikasi" class="form-label">Status Verifikasi <span
                        class="text-danger">*</span></label>
                <select name="status_verifikasi" id="crud_status_verifikasi" class="form-select" required>
                    <option value="disetujui"
                        {{ old('status_verifikasi', $lomba->status_verifikasi ?? 'disetujui') == 'disetujui' ? 'selected' : '' }}>
                        Disetujui</option>
    ...
    <div class="modal-footer">
        ...
        <button type="submit"
            class="btn btn-primary">{{ isset($lomba) ? 'Simpan Perubahan' : 'Tambah Lomba' }}</button>
    </div>
</form>
<script>
