                ...
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    @if($lomba->status_verifikasi == 'pending' || $lomba->status_verifikasi == 'ditolak')
                        <div>
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="modalActionLomba('{{ route('lomba.mhs.edit_form', $lomba->lomba_id) }}', 'Edit Pengajuan', 'modalFormLombaUser')"><i class="fas fa-edit"></i> Edit</button>
