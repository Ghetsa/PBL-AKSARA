    ...
    <div class="modal-body" style="max-height: 68vh; overflow-y: auto;">
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <label for="user_edit_nama_lomba" class="form-label">Nama Lomba <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6 mb-3">
                <label for="user_edit_pembukaan_pendaftaran" class="form-label">Pembukaan Pendaftaran <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6 mb-3">
                <label for="user_edit_batas_pendaftaran" class="form-label">Batas Pendaftaran <span class="text-danger">*</span></label>
            ...
            {{-- Kategori & Tingkat --}}
            <div class="col-md-6 mb-3">
                <label for="user_edit_kategori" class="form-label">Kategori Peserta <span class="text-danger">*</span></label>
            ...
            <div class="col-md-6 mb-3">
                <label for="user_edit_tingkat" class="form-label">Tingkat Lomba <span class="text-danger">*</span></label>
            ...
            {{-- Penyelenggara --}}
            <div class="col-md-12 mb-3">
                <label for="user_edit_penyelenggara" class="form-label">Penyelenggara <span class="text-danger">*</span></label>
            ...
            {{-- Bidang Keahlian --}}
            <div class="col-md-12 mb-3">
                <label class="form-label d-block mb-2">Bidang Keahlian Relevan <span class="text-danger">*</span></label>
                <div class="row ps-2">
                    @php
                ...
                <div id="hadiahInputsContainerUserEdit">
                    @if($lomba->daftarHadiah && $lomba->daftarHadiah->count() > 0)
                        ...
                        <div class="input-group input-group-sm mb-2 hadiah-input-group-user-edit">
                            ...
                            <button type="button" class="btn btn-danger remove-hadiah-btn-user-edit"><i class="fas fa-trash"></i></button>
                        </div>
                        @endforeach
                    @else
            ...
            {{-- Biaya --}}
            <div class="col-md-12 mb-3">
                <label for="user_edit_biaya" class="form-label">Biaya Pendaftaran (Kosongkan jika gratis)</label>
                <input type="number" name="biaya" id="user_edit_biaya" class="form-control form-control-sm" value="{{ old('biaya', $lomba->biaya) }}" min="0" placeholder="Cth: 50000">
                <span class="invalid-feedback error-biaya"></span>
            </div>

            {{-- Link Pendaftaran --}}
            <div class="col-md-6 mb-3">
                <label for="user_edit_link_pendaftaran" class="form-label">Link Pendaftaran (Opsional)</label>
            ...
            {{-- Link Penyelenggara --}}
            <div class="col-md-6 mb-3">
                <label for="user_edit_link_penyelenggara" class="form-label">Link Website Penyelenggara (Opsional)</label>
            ...
            {{-- Poster --}}
            <div class="col-md-12 mb-3">
                <label for="user_edit_poster" class="form-label">Poster Lomba (Opsional, Max 2MB: JPG, PNG, PDF)</label>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        if (typeof dataTableHistoriLomba !== 'undefined' && dataTableHistoriLomba.ajax) {
                            dataTableHistoriLomba.ajax.reload(null, false); // false agar tidak reset paging
                        }
                    } else {
                        Swal.fire({
                            title: 'Gagal!',
