        ...
        @if (Auth::user()->role == 'admin')
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ url('/periode') }}"
                            class="pc-link {{ $activeMenu == 'periode' ? 'active' : '' }}">
                    ...
                    <li class="pc-item">
                        <a href="{{ url('/laporan') }}"
                            class="pc-link {{ $activeMenu == 'laporan' ? 'active' : '' }}">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ url('/bimbingan') }}"
                            class="pc-link {{ $activeMenu == 'bimbingan' ? 'active' : '' }}">
                            <span class="pc-micon"><i class="ti ti-file-check"></i></span>
                    ...
                    <li class="pc-item">
                        <a href="{{ route('lomba.publik.index') }}" class="pc-link {{ $activeMenu == 'lomba' ? 'active' : '' }}">
                            <span class="pc-micon"><i class="ti ti-award"></i></span>
