                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="card-tools d-flex flex-wrap gap-1 mt-2 mt-md-0">
                            <button class="btn btn-sm btn-primary" onclick="tambahKeahlian()"><i
                                    class="fas fa-plus-circle"></i> Tambah Keahlian</button>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-select form-select-sm" id="status_filter_keahlian"
                                            name="status_filter_keahlian">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover dt-responsive wrap" id="dataKeahlianUser"
                                style="width: 100%;">
                                <thead>
                                    <tr>
