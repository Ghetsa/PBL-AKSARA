...
<form id="formTambahPrestasi" method="POST" action="{{ route('prestasi.mahasiswa.store_ajax') }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-9">
                <input type="number" class="form-control" id="create_tahun" name="tahun" placeholder="YYYY" min="1900" max="{{ date('Y') + 1 }}" value="{{ date('Y') }}" required>
                <span class="invalid-feedback error-text" id="error-tahun"></span>
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-9">
                <input type="file" class="form-control" id="create_file_bukti" name="file_bukti" accept="pdf, jpg, jpeg, png" required>
