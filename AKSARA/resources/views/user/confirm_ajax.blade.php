...
@else
    ...
    <form action="{{ route('user.delete_ajax', $user->user_id) }}" method="POST" id="form-delete-ajax"> {{-- Ganti ID form agar lebih spesifik --}}
        @csrf
        @method('DELETE')
        ...
        <div class="modal-body">
            ...
            <p>Detail User:</p>
            <ul>
                <li><strong>Role User:</strong> {{ $user->role }}</li>
