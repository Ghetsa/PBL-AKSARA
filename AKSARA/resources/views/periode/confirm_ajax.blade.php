...
@else
    ...
    <form action="{{ route('periode.delete_ajax', $periode->periode_id) }}" method="POST" id="form-delete-ajax">
        ...
        <div class="modal-body text-center py-4">
            ...
            <div class="text-danger fw-bold mt-4"><i class="fas fa-exclamation-circle flex-shrink-0 me-2"></i>Data periode semester yang dihapus tidak dapat dipulihkan!</div>
        </div>
