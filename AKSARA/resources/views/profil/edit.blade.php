    ...
    <div class="modal-content">
        <form id="formUpdateProfile" method="POST" action="{{ route('profile.update_ajax') }}"
            ...
            <div class="modal-body" style="max-height: 75vh; overflow-y: auto;">
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="ms-1 minat-level-container"
                                                ...
                                                <span
                                                    class="invalid-feedback error-minat_level.{{ $bidang->bidang_id }}"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {{-- Bagian Pengalaman (Pastikan $selectedPengalaman dan $allBidangOptions tersedia jika ada select
                bidang di sini) --}}
