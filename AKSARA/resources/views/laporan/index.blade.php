...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Laporan Data Prestasi Mahasiswa (Disetujui)</h6>
            <a href="{{ route('admin.laporan.prestasi.export') }}" id="exportPrestasiBtn" class="btn btn-sm btn-success shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Export Excel/PDF</a>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Laporan Data Lomba (Disetujui)</h6>
             <a href="{{ route('admin.laporan.lomba.export') }}" id="exportLombaBtn" class="btn btn-sm btn-success shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Export Excel/PDF</a>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-4">
